...
import { Search, Sun, Moon, Menu, X, LogOut, User as UserIcon, Heart } from 'lucide-react'
    ...
    <header className="sticky top-0 z-40 border-b border-gray-200 bg-white/80 backdrop-blur-lg dark:border-gray-800 dark:bg-gray-900/80">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <Link to="/saved" className="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 flex items-center gap-1">
